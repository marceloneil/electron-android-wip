...
import org.electroncash.electroncash.MainActivity;
...
public abstract class PythonService extends Service implements Runnable {
    ...
    public void onCreate() {
        ...
        AssetExtract.extractAsset(getApplicationContext(), "private.mp3", new File(getAppRoot()));
        super.onCreate();
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        androidExtDir = extras.getString("androidExtDir");
        androidDataDir = extras.getString("androidDataDir");
    ...
    @Override
    public void run() {
        PythonUtil.loadLibraries(new File(getAppRoot()));
        nativeStart(androidPrivate, androidArgument, serviceEntrypoint, pythonName, pythonHome,
                pythonPath, pythonServiceArgument, androidExtDir, androidDataDir, androidUnpack);
        stopSelf();
    }
    ...
    public static native void nativeStart(String androidPrivate, String androidArgument,
                                          ...
                                          String pythonServiceArgument, String androidExtDir,
                                          String androidDataDir, String androidUnpack);
}
